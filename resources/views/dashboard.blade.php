            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    ...
                    <div class="p-6 space-y-3 text-sm text-gray-700">
                        <p class="mb-4">Para recibir asistencia, puedes comunicarte con nosotros a través de:</p>
                        <div class="flex items-center px-4 py-3 bg-gray-50 rounded-lg">
                            ...
                            <span>Teléfono: <strong>(55) 5972 8130</strong> Ext. <strong>232</strong> </span>
                        </div>
                        <div class="flex items-center px-4 py-3 bg-gray-50 rounded-lg">
                            <svg class="h-5 w-5 mr-3 text-secondary" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span>Email: <strong>soporte@genbio.com.mx</strong></span>
                        </div>
                    </div>
                </div>
            </div>
